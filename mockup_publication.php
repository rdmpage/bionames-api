					...
					if (data.identifier)
					{
						for (var j in data.identifier)
						{
							switch (data.identifier[j].type)
							{
								...
								case "pmc":
									html += '<tr><td class="muted">JSTOR</td><td><a href="http://www.ncbi.nlm.nih.gov/pmc/PMC' + data.identifier[j].id + '" target="_new"><i class="icon-share"></i> ' + 'PMC' + data.identifier[j].id + '</a></td></tr>';
									break;
